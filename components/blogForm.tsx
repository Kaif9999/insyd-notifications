      ...
      >
        ...
        <div className="mb-5">
          ...
          <textarea 
            ...
            required 
            disabled={isSubmitting}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg h-32 resize-vertical focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent disabled:opacity-50 text-black placeholder-gray-700"
